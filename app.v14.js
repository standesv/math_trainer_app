...
els.navScores.addEventListener("click", () => { showScreen("scores"); try { renderScores(); } catch (e) { showFatal("Erreur Scores", e); } });
...
// ---------------- Storage ----------------
const PROFILES_KEY = "math_trainer_profiles_v14";
const ACTIVE_PROFILE_KEY = "math_trainer_active_profile_v14";
...
function historyKeyFor(profile) { return `math_trainer_history_v14::${profile}`; }
function progressKeyFor(profile) { return `math_trainer_progress_v14::${profile}`; }
